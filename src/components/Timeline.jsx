...
function Timeline() {
    ...
    <div className="w-full h-fit mb-36 px-10 lg:px-28 ">
        <h1 className="uppercase text-[4em] lg:text-[7em] font-bold text-neutral-200 dark:text-white/10 text-center" data-aos="fade-up" data-aos-duration="400">
            Experience
        </h1>
      <div className="w-full rounded-lg overflow-hidden  flex justify-center flex-col items-center">
        {works.map((work, index) => (
          <section className="border-b-[.5px] border-neutral-600 py-10 flex w-3/4 gap-10 justify-between"data-aos="fade-up" data-aos-duration="700">
            <div className="w-fit">
