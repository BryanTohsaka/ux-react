  ...
  return (
    <>
      ...
      <div className="w-full h-fit flex flex-col overflow-auto ">
        <div className="bg-w1 bg-top bg-no-repeat bg-cover bg-fixed h-60">
          <div className=" backdrop-blur-sm w-full h-full flex justify-center items-center uppercase text-4xl font-bold text-lime-200 dark:bg-neutral-900/60 ">
            <h1>title</h1>
          </div>
        </div>
        ...
        <div className="py-10 lg:px-96 px-10">
          ...
          <div>
            ...
            <button
              data-aos="fade-right"
              href=""
              className="border-2 dark:border-lime-100 border-neutral-800 rounded px-5 py-2 mt-10 dark:text-lime-200"
            >
              Ver prototipo
            </button>
          </div>
          ...
          {/* intro*/}
          <div>
            <h3 data-aos="fade-up" data-aos-delay="100" className=" capitalize font-semibold text-3xl dark:text-neutral-100 my-6">
              Objetivos del Proyecto:
            </h3>
            <div className=" mt-10 dark:text-neutral-400 pl-8">
              <ul data-aos="fade-up" data-aos-delay="200" className="list-disc">
                <li className="mt-4">
          ...
          {/* intro*/}
          <div>
            <h3 data-aos="fade-up" data-aos-delay="200" className=" capitalize font-semibold text-3xl dark:text-neutral-100 my-6">
              Wireframes y Prototipos:
            </h3>
            <p data-aos="fade-up" data-aos-delay="300"  className=" mt-10 dark:text-neutral-400">
            ...
            <img data-aos="zoom-in-up" data-aos-delay="500"  src={W1} alt="" className="pt-10" />
          </div>
          {/*end intro*/}

          {/* intro*/}
          <div>
            <h3 data-aos="fade-up" data-aos-delay="300" className=" capitalize font-semibold text-3xl dark:text-neutral-100 my-6">
            ...
            <div className=" mt-10 dark:text-neutral-400 pl-8">
              <ul data-aos="fade-up" data-aos-delay="300" className="list-disc">
                <li className="mt-4">
            ...
            <img data-aos="zoom-in-up" data-aos-delay="400" data-aos-duration="1000" src={W1} alt="" className="pt-10" />
          </div>
          {/*end intro*/}
        </div>
      </div>
